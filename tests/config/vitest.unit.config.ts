...
export default defineConfig({
  ...
  test: {
    ...
    exclude: ["tests/unit/lib/stock-movements.test.ts", "tests/unit/lib/cogs.test.ts", "tests/unit/lib/party-owner.test.ts", "tests/unit/lib/party-merge.test.ts", "tests/unit/lib/activity-ingest.test.ts", "tests/unit/lib/party-resolver.test.ts"],
